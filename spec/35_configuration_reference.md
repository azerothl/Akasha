...
| `providers.<nom>.api_key_ref` | string | Non | Référence Clé API : `vault://nom_cle` (vault), ou nom de clé sans préfixe (vault puis env), ex. `openrouter_api_key` ; sinon variable d’env. |
