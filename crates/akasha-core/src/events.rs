...
pub enum EventType {
    ...
    TaskDecomposed,
    SubAgentSpawned,
    SubagentStartupPending,
    SubagentStartupStarted,
    ProgressUpdate,
    TaskCompleted,
    TaskFailed,
    SecurityAlert,
    ...
    ToolCallStarted,
    ToolCallFinished,
    /// Normalized orchestration timeline marker. Payload includes `name` and timing data.
    TimelineMilestone,
...
impl EventType {
    pub fn as_str(&self) -> &'static str {
        match self {
            ...
            Self::SubagentStartupPending => "subagent_startup_pending",
            Self::SubagentStartupStarted => "subagent_startup_started",
            ...
            Self::TimelineMilestone => "timeline_milestone",
    ...
    pub fn from_str(s: &str) -> Option<Self> {
        match s {
            ...
            "subagent_startup_pending" => Some(Self::SubagentStartupPending),
            "subagent_startup_started" => Some(Self::SubagentStartupStarted),
            ...
            "timeline_milestone" => Some(Self::TimelineMilestone),
